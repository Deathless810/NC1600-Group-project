...
/**
 * Flight_filter() checks the given depature city, arrival city and date in the flight Array 
 * list adding to the cache arraylist which will then be returned
 * @param date format {dd/mm/yyyy} type: string
 * @param depart type: string
 * @param arrival type: string
 * @return ArrayList containing all valid flight given the parameters
 */
