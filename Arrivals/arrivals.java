...
public class arrivals {
	 ...
	 */
	public arrivals() throws FileNotFoundException {
		try {
			initialize();
	...
	private void initialize() throws FileNotFoundException {
		...
		btnarrivals.setBounds(326, 771, 104, 37);
		frame.getContentPane().add(btnarrivals);
		
		JLabel lblNewLabel_1_1 = new JLabel("Click Here For Today's Arrivals");
				...
				for (int i = 0; i < arrivals.flights.size() ; i++) {
...

					{
						...
						{ 
							...
							System.out.println("Flight " + arrivals.flights.get(i)[10] + " Departing From " + arrivals.flights.get(i)[7] + " To " + arrivals.flights.get(i)[9] + " Is On Time! ");	
							System.out.println(" ");	
