...
public class ReturningA_318 {
	...
	public class SeatArray {
	    ...
	    public SeatArray() {
	        ...
	        String[] seatNames = {
	        		...
	        		"SEAT13", "SEAT14", "SEAT15", "SEAT16", "SEAT17", "SEAT18",
	        		"SEAT19", "SEAT20", "SEAT21", "SEAT22", "SEAT23", "SEAT24", 
	        		"SEAT25", "SEAT26", "SEAT27", "SEAT28", "SEAT29", "SEAT30", 
	        		"SEAT31", "SEAT32", "SEAT33", "SEAT34", "SEAT35", "SEAT36",
	        		"SEAT37", "SEAT38", "SEAT39", "SEAT40", "SEAT41", "SEAT42",
	        		"SEAT43", "SEAT44", "SEAT45", "SEAT46", "SEAT47", "SEAT48",
	        		"SEAT49", "SEAT50", "SEAT51", "SEAT52", "SEAT53", "SEAT54",
	        		"SEAT55", "SEAT56", "SEAT57", "SEAT58", "SEAT59", "SEAT60",
	        		"SEAT61", "SEAT62", "SEAT63", "SEAT64"
	        };
	 ...
	 */
			...
			public void run() {
				try {
					ReturningA_318 window = new ReturningA_318();
	 ...
	 */
	public ReturningA_318() {
		initialize();
	}
	
	public ReturningA_318(String string) {
	...
	SEAT5.setBackground(new Color(255, 255, 255));
	...
	SEAT14.setBackground(new Color(255, 0, 0));
	...
	btnNewButton_8.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
	        ...
	        // Create a new JOptionPane to display the message
	        JOptionPane.showMessageDialog(null, "Dear Customer, thanks, your seats are reserved");

	        // Terminate the program after closing the new window
	        System.exit(0);
	    }
	});
	...
	JLabel lblNewLabel_1 = new JLabel("Returning: Airbus A318");
	...
	JButton btnNewButton_8_1 = new JButton("Select Randon Seat");
		ActionListener selectRandomSeatListener = new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        List<JButton> seatButtons = Arrays.asList(SEAT3, SEAT4, 
		        		SEAT5, SEAT8, SEAT9, SEAT10, SEAT11, SEAT12, 
		        		SEAT13, SEAT14, SEAT15, SEAT17, SEAT18, SEAT19,
		        		SEAT20, SEAT21, SEAT22, SEAT23, SEAT24, SEAT25, SEAT26, 
		        		SEAT27, SEAT28, SEAT29, SEAT30, SEAT31, SEAT32, SEAT33, 
		        		SEAT34, SEAT35, SEAT36, SEAT37, SEAT38, SEAT39, SEAT40, 
	...
	btnNewButton_1.setBounds(515, 476, 89, 23);
	btnNewButton_1.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
	        exportSelectedSeatsToFile("C:\\Users\\mohsi\\OneDrive\\Desktop\\Assignments\\Airbus.txt");
	    }
	});
