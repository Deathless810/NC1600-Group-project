...
import javax.swing.JToggleButton;
	public class ReturningB_747 {
		...
		public class SeatArray {
		    ...
		    public SeatArray() {
		        seats = new JToggleButton[12][12];// to be set after the all other component merges
		        String[] seatNames = {"Seat1", "Seat2", "Seat3", "Seat4", "Seat5", "Seat6", "Seat7", "Seat8", "Seat9", "Seat10",
	                      ...
	                      "Seat51", "Seat52", "Seat53", "Seat54", "Seat55", "Seat56", "Seat57", "Seat58", "Seat59", "Seat60",
	                      "Seat61", "Seat62", "Seat63", "Seat64", "Seat65", "Seat66", "Seat67", "Seat68", "Seat69", "Seat70",
	                      "Seat71", "Seat72", "Seat73", "Seat74", "Seat75", "Seat76", "Seat77", "Seat78", "Seat79", "Seat80",
	                      "Seat81", "Seat82", "Seat83", "Seat84"};


		        int index = 0;
		        for (int i = 0; i < seats.length; i++) {
		            for (int j = 0; j < seats[i].length; j++) {
		                seats[i][j] = new JToggleButton(seatNames[index]);
		                index++;
		            }
		        }
		    }
		 ...
		 */
				...
				public void run() {
					try {
						ReturningB_747 window = new ReturningB_747();
  ...
  public void actionPerformed(ActionEvent e) {
      ...
      if (n == JOptionPane.YES_OPTION) {
          ...
          popup.setVisible(true);
			...
			JLabel lblNewLabel_1 = new JLabel("Returning: Boeing 747");
			...
			Seat78.setBackground(new Color(255, 0, 0));
			...
			btnNewButton_8.addActionListener(new ActionListener() {
			    public void actionPerformed(ActionEvent e) {
			        ...
			        JFrame popupFrame = new JFrame("Reservation Confirmed");
			        popupFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
			        popupFrame.setSize(500, 200);
			        popupFrame.setLocationRelativeTo(null);

			        // Create a JLabel with the message
			        JLabel messageLabel = new JLabel("Dear customer, thanks! Your seats are reserved.", SwingConstants.CENTER);
			        ...
			        // Add a WindowListener to the popupFrame
			        popupFrame.addWindowListener((WindowListener) new WindowAdapter() {
			            @Override
			...
			ActionListener selectRandomSeatListener = new ActionListener() {
			    public void actionPerformed(ActionEvent e) {
			        ...
			        List<JButton> seatButtons = Arrays.asList(Seat11, Seat12, Seat13, Seat14, Seat15, Seat16, Seat17,
			        		Seat18, Seat19, Seat20, Seat21, Seat22, Seat23, Seat24, Seat25, Seat26, Seat27, 
			        		Seat28, Seat29, Seat30, Seat31, Seat32, Seat33, Seat34, Seat35, Seat36, Seat37,
			...
			btnNewButton_9_2_1.setForeground(new Color(255, 255, 255));
			...
			btnNewButton_1.setBounds(535, 543, 89, 23);
			btnNewButton_1.addActionListener(new ActionListener() {
			    public void actionPerformed(ActionEvent e) {
			        exportSelectedSeatsToFile("C:\\Users\\mohsi\\OneDrive\\Desktop\\Assignments\\mine.txt");
			    }
			});
			frame1.getContentPane().add(btnNewButton_1);
			}

			private void exportSelectedSeatsToFile(String filePath) {
			    try (BufferedWriter bw = new BufferedWriter(new FileWriter(filePath))) {

			        // Initialize the seats array with actual seat objects
			        Object[][] seats = {}; // Replace ... with your seat objects initialization code
			        for (int i = 0; i < seats.length; i++) {
			            for (int j = 0; j < seats[i].length; j++) {
			                if (((AbstractButton) seats[i][j]).isSelected()) {
			                    bw.write("Seat[" + i + "][" + j + "] is selected");
			                    bw.newLine();
			                }
			            }
			        }
		...
		// This window is shown when the customer wants to book a return ticket
